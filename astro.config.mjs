	...
	integrations: [
		starlight({
			...
			sidebar: [
                ...
                { label: 'Connect', collapsed: true, items: [{ autogenerate: { directory: 'connect' } }] },
                { label: 'Operate', collapsed: true, items: [{ autogenerate: { directory: 'operate' } }] },
